...
if __name__ == '__main__':
    ...
    test_updater.updater__maturities(["tests/environments/", "test_all_methods", "tests/log/"])
    test_updater.updater__amortisation(["tests/environments/", "test_all_methods", "tests/log/"])
    test_updater.updater__get_funding(["tests/environments/", "test_all_methods", "tests/log/"])
    ...
    test_updater.updater__check_liquidity(["tests/environments/", "test_all_methods", "tests/log/"])
    test_updater.updater__capitalise_new(["tests/environments/", "test_all_methods", "tests/log/"])
    test_updater.updater__check_consistency(["tests/environments/", "test_all_methods", "tests/log/"])
