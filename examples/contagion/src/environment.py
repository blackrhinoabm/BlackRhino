...
class Environment(BaseConfig):
    ...
    static_parameters["theta"] = 0  # theta reflectes the state of the world

    static_parameters["m"] = 0 # benchmark case where m = f0/f1 and the probabilities don't depend on the signal anymore
    ...
    def initialize(self, environment_directory, identifier):
        ...
        self.static_parameters["m"] = 0

        self.static_parameters["theta"] = 0
