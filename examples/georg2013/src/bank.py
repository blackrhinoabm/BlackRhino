...
#
	...
	num_banks = 0 # number of banks in the economy
...
#
	...
	#-------------------------------------------------------------------------
	def get_parameters_from_file(self,  bankFilename, state,  num_banks,  time):
...
#
	...
	def initialize_transactions(self, state):
		...
		numTransactions = int(round(self.assetNumber / self.num_banks))
...
#
	...
	def initialize_standard_bank(self):
		...
		self.num_banks = 3.0 # number of banks in the economy
