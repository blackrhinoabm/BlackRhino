...
class Cbank():
    ...
    def initialize_assets(self, updater, current_step):
        ...
        if hasattr(self, 'repo'):
            ...
            self.stock_variables['Total_assets'] = self.Loans + self.stock_variables['Loans'] + self.stock_variables['Cash'] + self.GB + self.CB
            self.stock_variables['Liabilities'] = self.Deposits
            self.stock_variables['Equity'] = self.Total_assets - self.Liabilities

            self.Total_liabilities = self.Equity + self.Liabilities
    ...
    def check_consistency(self):
        ...
        if self.Total_assets == self.Total_liabilities:
            print "balance sheet identity for cbank holds"
        else:
            print "ooups, balance sheet identity for cbank does not hold"
    # -------------------------------------------------------------------------
