...
class Cbank():
    ...
    def initialize_assets(self, updater, current_step):
        ...
        if hasattr(self, 'repo'):
            ...
            self.stock_variables['Total_assets'] = self.stock_variables['Loans'] + self.stock_variables['Loans'] + self.stock_variables['Cash'] + self.stock_variables['GB'] + self.stock_variables['CB']
            self.stock_variables['Liabilities'] = self.stock_variables['Deposits']
            self.stock_variables['Equity'] = self.stock_variables['Total_assets'] - self.stock_variables['Liabilities']

            self.stock_variables['Total_liabilities'] = self.stock_variables['Equity'] + self.stock_variables['Liabilities']
    ...
    def print_balance_sheet(self):
        ...
        print "Loans to Real economy:", self.stock_variables['Loans'], "\n"
        print  "Total:", self.stock_variables['Total_assets'] , "\n"
        print "Liabilities:" , "\n"
        print "Deposits", self.stock_variables['Deposits'], " \n"
...
########################################
    def update_balance_sheets(self, updater, environment, current_step, scenario):
        ...
        if current_step > 0 and scenario=='benchmark':
            ...
            self.stock_variables['Equity'] = self.stock_variables['Total_assets'] - self.stock_variables['Deposits']

            self.stock_variables['Total_liabilities'] = self.stock_variables['Equity'] + self.stock_variables['Deposits']
