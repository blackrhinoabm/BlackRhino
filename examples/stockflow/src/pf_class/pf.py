...
class PF():
    ...
    def __init__(self):
        ...
        self.stock_variables['Annuity'] = 0.0
    ...
    def initialize_assets(self, updater, current_step):
        ...
        self.stock_variables['Repo']= self.stock_variables['GB'] * updater.pGB*(1 - updater.rates['haircut'])
        self.stock_variables['GB'] = self.stock_variables['GB'] * updater.pGB + self.stock_variables['Repo']/updater.pGB
        ...
        self.stock_variables['HHPO'] = self.stock_variables['Total_assets'] - self.stock_variables['Repo']- self.stock_variables['Equity']
        self.stock_variables['Total_liabilities'] = self.stock_variables['Repo']+ self.stock_variables['Equity'] + self.stock_variables['HHPO']
...
# -------------------------------------------------------------------------
    ...
    def print_balance_sheet(self):
        ...
        print "Liabilities:" , "\n"
        print "Repo", self.stock_variables['Repo'], " \n"
        print "HHPO", self.stock_variables['HHPO'], " \n"
    ...
    def update_balance_sheets(self, updater, environment, current_step, scenario):
        ...
        if current_step > 0 and scenario=='benchmark':
            ...
            self.stock_variables['Total_assets'] = self.stock_variables['Total_assets'] + self.stock_variables['net_income'] - self.stock_variables['Annuity']
            ...
            self.stock_variables['HHPO'] = self.stock_variables['HHPO']*(1 + updater.i_GB) - self.stock_variables['Annuity']

            self.stock_variables['Equity'] = self.stock_variables['Total_assets'] - self.stock_variables['HHPO'] - self.stock_variables['Repo']
            self.stock_variables['Total_liabilities'] = self.stock_variables['Equity'] + self.stock_variables['HHPO']  + self.stock_variables['Repo']
